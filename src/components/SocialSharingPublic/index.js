  ...
  return (
    <div>
      <p className="private-text">
        Private rooms can only be accessed by the second device using a link or
        QR Code. You do not need to be on the same network.
      </p>
      <div className="socialSharing">
        <div className="whatsapp button-container">
          ...
          <IconButton
            ...
            onClick={() =>
              window.open(
                `https://web.whatsapp.com/send?text=Quick Join Now ${params}`
              )
            }
          >
            Share
        ...
        <div className="copyLink button-container">
          <IconButton svg={copyLink} onClick={copyToClipboard}>
            Copy
          </IconButton>
        </div>
        <div className="PrivateLink button-container">
          <IconButton onClick={() => create()} svg={Lock}>
            Private Room
          </IconButton>
        </div>
      </div>
